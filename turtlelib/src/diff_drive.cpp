...
namespace turtlelib
{
    ...
    // assumptions:
    //  1. both wheels started and stopped rotating simultaneously
    //  2. both wheels rotate at a constant velocity
    //  3. the wheels achieved their velocity instantaneously
    //  4. no wheel slippage
    //  5. the wheels rotated the shortest distance to achieve the new configuration
